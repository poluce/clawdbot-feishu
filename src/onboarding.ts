...
const channel = "clawdbot_feishu" as const;
...
const dmPolicy: ChannelOnboardingDmPolicy = {
  label: "Feishu",
  channel,
  policyKey: "channels.clawdbot_feishu.dmPolicy",
  allowFromKey: "channels.clawdbot_feishu.allowFrom",
  getCurrent: (cfg) => {
...
export const feishuOnboardingAdapter: ChannelOnboardingAdapter = {
  ...
  getStatus: async ({ cfg, accountOverrides }) => {
    const override = accountOverrides?.clawdbot_feishu?.trim();
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    const feishuOverride = accountOverrides?.clawdbot_feishu?.trim();
  ...
  disable: (cfg) => ({
    ...
    channels: {
      ...cfg.channels,
      clawdbot_clawdbot_feishu: { ...cfg.channels?.clawdbot_feishu, enabled: false },
    },
  }),
};
